...
Now we can take a peek at what the data includes using dplyr's glimpse(), just looking at the first 10 columns to save space

```{r}
glimpse(MetObjects[,1:10],width = 50)
```
